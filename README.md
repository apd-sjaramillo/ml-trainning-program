...
The current version includes Day 1, Day 2, Day 4, Day 5, and Day 6.
...
- Day 6: LLM fundamentals, prompt structure, structured outputs, local models, and a guardrail-first endpoint
